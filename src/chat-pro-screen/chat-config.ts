...
export const initialMessages = (): Message[] => {
  return [
    ...
    },
    {
      type: 'text',
      content: {
        text: 'How are you doing todya? What can I do for you',
      },
    },
    {
      type: 'card',
          ...
          array: [
            {
              ...
              list: [
                ...
                {
                  title: 'What can I do with ChatGPT?',
                  hot: true,
                  content: 'What can I do with ChatGPT, give me some usecases and examples'
                },
                {
                  title: 'How ChatGPT improve my life',
                  content: 'How ChatGPT improve my life?'
                },
                {
                  title: 'Is ChatGPT gonna replace the search engine?',
                  content: 'Is ChatGPT gonna replace the search engine?'
                }
              ]
            },
            {
...
let chatConfig = {
  ...
  // 首屏消息
  messages: initialMessages().concat(allMessages),
  // 快捷短语
  quickReplies: [
    { name: 'Tell me more about it' },
    { name: 'Continue' },
    { name: 'Regenerate your response' },
    { name: 'Not correct, try again' },
